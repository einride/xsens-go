...
const _MessageIdentifier_name = ""
...
var _MessageIdentifier_map = map[MessageIdentifier]string{
	...
	230: _MessageIdentifier_name[2339:2351],
	231: _MessageIdentifier_name[2351:2366],
	232: _MessageIdentifier_name[2366:2384],
	233: _MessageIdentifier_name[2384:2405],
}
